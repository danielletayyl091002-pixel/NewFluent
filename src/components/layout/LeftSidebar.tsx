  ...
  return (
    <aside style={{
      ...
      <div style={{ borderTop: '1px solid var(--border)', padding: '8px' }}>
        <NavLink itemId="home" collapsed={collapsed} hoveredItem={hoveredItem} setHoveredItem={setHoveredItem} onClick={() => navigateTo('/')} icon={<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 12l9-9 9 9"/><path d="M5 10v10h14V10"/></svg>}>Today</NavLink>
        <NavLink itemId="calendar" collapsed={collapsed} hoveredItem={hoveredItem} setHoveredItem={setHoveredItem} onClick={() => navigateTo('/calendar')} icon={<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>}>Calendar</NavLink>
